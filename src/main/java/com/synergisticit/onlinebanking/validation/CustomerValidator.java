...
public class CustomerValidator implements Validator {
	...
	public void validate(Object obj, Errors errors) {
		...
		//VALIDATION FOR NAME
		  ValidationUtils.rejectIfEmptyOrWhitespace(errors, "customerfname",  
				    "customer.customerfname.value", "first name must be alphabets");
		  if(!(customer.getCustomerfname().matches("[a-zA-Z ]*$"))){
			  errors.rejectValue("customerfname", "customer.customerfname.value", "first name must be alphabets");
		  }
		  //VALIDATION FOR NAME
		  ValidationUtils.rejectIfEmptyOrWhitespace(errors, "customerlname",  
				    "customer.customerlname.value", "last name must be alphabets");
		  if(!(customer.getCustomerlname().matches("[a-zA-Z ]*$"))){
			  errors.rejectValue("customerlname", "customer.customerlname.value", "last name must be alphabets");
		  }
