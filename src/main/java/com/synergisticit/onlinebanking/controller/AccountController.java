...
public class AccountController {
	...
	public String saveAccount(@Valid @ModelAttribute ("account")Account acc,BindingResult result ) throws MessagingException, DocumentException{
		...
		else
		{
			...
			mailService.sendMail(mailTo, subject, body, acc);
			return "success";
		}
