...
<div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="/createrole">CREATE ROLE</a><br></li>
            <li class="active"><a href="/depositform"> DEPOSIT MONEY</a><br></li>
         <li class="active"> <a href="/withdrawform"> WITHDRAW MONEY</a><br></li>
          <li class="active">  <a href="/transamt"> TRANSFER MONEY</a><br></li>
