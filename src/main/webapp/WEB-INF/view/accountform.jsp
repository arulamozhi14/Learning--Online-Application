...
body {
  ...
  -moz-osx-font-smoothing: grayscale;      
	...
	<%Date currentDate=new Date();
		...
		%>
	<tr><td> Account OpenDate <form:input   path="opendate" value="<%=simple.format(currentDate)%>" disabled="false"/> </td>
...
<tr><td> Customer id  <form:input path="customer" name="customer"/> </td>
