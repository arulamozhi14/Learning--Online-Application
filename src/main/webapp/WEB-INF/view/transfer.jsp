...
body {
  ...
  -moz-osx-font-smoothing: grayscale;      
	...
	<td><form:errors path="fromAccount" cssClass="error"/> </td></tr>
	
	<tr><td> Account to  <form:input path="toAccount"/> </td>
	<td><form:errors path="toAccount" cssClass="error"/> </td></tr>
	

	
	<tr><td>  Date <form:input   path="txdate"/> </td>
	<td><form:errors path="txdate" cssClass="error"/> </td></tr>
	...
	<td><form:errors path="amounttx" cssClass="error"/> </td></tr>
